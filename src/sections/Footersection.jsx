...
const Footersection = () => {
    ...
    useEffect(() => {
        ...
        const observer = new IntersectionObserver(
            ...
            // FIX 1: Margin 400px se 1200px kiya. 
            // Ab video user k scroll karne se kafi pehle background me load/decode hogi.
            // Is se jab user footer par pohnchta hai tou stuck nahi hoga.
            { rootMargin: "1200px" } 
        );
  ...
  return (
    // FIX 2: Poore section se willChange: 'transform' hata diya. Ye GPU ko overload kar raha tha.
    <section className='footer-section' ref={sectionRef}>
        
        {/* FIX 3: decoding="async" for heavy background image taake thread block na ho */}
        <img loading="lazy" decoding="async" src="/images/footer-dip.png" alt="" className='w-full object-cover translate-y-1' />
        ...
        <div className="2xl:h-[110dvh] relative md:pt-[20vh] pt-[10vh]">
            ...
            {isMobile ? ( 
                ...
                shouldLoadMedia && (
                    <video 
                        ...
                        // mix-blend-lighten CPU par heavy hota hai, jaldi load krwane se ab lag nahi ayega
            ...
            <div className='flex-center gap-5 relative z-10 md:mt-20 mt-5'>
                ...
                <div className="social-btn">
                    <img loading="lazy" decoding="async" src="/images/tiktok.svg" alt="TikTok" />
                </div>
            </div>
            ...
            <div className="mt-49 md:px-5 px-5 flex gap-10 md:flex-col flex-col justify-between text-milk font-paragraph md:text-sm font-medium max-md:text-[11px] max-md:gap-8 max-md:relative max-md:z-10">
                ...
                <div className="max-w-sm absolute md:right-[5%] max-md:relative max-md:mt-6 max-md:max-w-full">
                    ...
                    <div className=" mt-10 flex items-center w-[428px] justify-between border-b border-milk pb-2 group max-md:w-full max-md:mt-8">
                        ...
                        />
                        <button type="submit" className="text-milk ml-4 cursor-pointer max-md:shrink-0" aria-label="Submit Email">
